...
| [hermes-governance-runtime.md](hermes-governance-runtime.md) | Runtime store wiring seam + first real governance consumer: `get_governance_store()`, `get_task_governance_status()`, DB path resolution, read-only query surface, execution-boundary preservation (Phase 6 runtime integration) |
