"""EA-4E.16 pre-live negative gate tests."""

from __future__ import annotations

from tools.hermes_core.opencode_live_binding import OpenCodeLiveBindingHarness
...
def test_authority_receiver_mismatch():
    harness = OpenCodeLiveBindingHarness()
    wrong_auth = _build_auth("kilo-cli-agent", "mismatch")
    activation = _build_activation("opencode-cli-agent", "ENABLED")
    request = _build_request("opencode-cli-agent")
    result = harness.execute(
        receiver_id="opencode-cli-agent",
...
def test_missing_activation():
    harness = OpenCodeLiveBindingHarness()
    auth = _build_auth("opencode-cli-agent", "missing-act")
    request = _build_request("opencode-cli-agent")
    result = harness.execute(
        receiver_id="opencode-cli-agent",
        authority=auth,
...
def test_disabled_activation():
    harness = OpenCodeLiveBindingHarness()
    auth = _build_auth("opencode-cli-agent", "disabled-act")
    activation = _build_activation("opencode-cli-agent", "DISABLED")
    request = _build_request("opencode-cli-agent")
    result = harness.execute(
        receiver_id="opencode-cli-agent",
        authority=auth,
...
def test_activation_receiver_mismatch():
    harness = OpenCodeLiveBindingHarness()
    auth = _build_auth("opencode-cli-agent", "act-mismatch")
    wrong_activation = _build_activation("kilo-cli-agent", "ENABLED")
    request = _build_request("opencode-cli-agent")
    result = harness.execute(
        receiver_id="opencode-cli-agent",
        authority=auth,
...
def test_router_contract_mismatch():
    harness = OpenCodeLiveBindingHarness()
    auth = _build_auth("opencode-cli-agent", "router-mm")
    activation = _build_activation("opencode-cli-agent", "ENABLED", router_contract_id="wrong")
    request = _build_request("opencode-cli-agent")
    result = harness.execute(
        receiver_id="opencode-cli-agent",
        authority=auth,
...
def test_authority_contract_mismatch():
    harness = OpenCodeLiveBindingHarness()
    auth = _build_auth("opencode-cli-agent", "auth-mm")
    activation = _build_activation("opencode-cli-agent", "ENABLED", authority_contract_id="wrong")
    request = _build_request("opencode-cli-agent")
    result = harness.execute(
        receiver_id="opencode-cli-agent",
        authority=auth,
...
def test_transport_mismatch():
    harness = OpenCodeLiveBindingHarness()
    auth = _build_auth("opencode-cli-agent", "transport-mm")
    activation = _build_activation("opencode-cli-agent", "ENABLED", transport_contract_id="wrong")
    request = _build_request("opencode-cli-agent")
    result = harness.execute(
        receiver_id="opencode-cli-agent",
        authority=auth,
...
def test_model_binding_mismatch():
    harness = OpenCodeLiveBindingHarness()
    auth = _build_auth("opencode-cli-agent", "model-mm")
    activation = _build_activation("opencode-cli-agent", "ENABLED", model_binding_id="wrong")
    request = _build_request("opencode-cli-agent")
    result = harness.execute(
        receiver_id="opencode-cli-agent",
        authority=auth,
...
def test_execution_budget_exhausted():
    harness = OpenCodeLiveBindingHarness()
    auth = _build_auth("opencode-cli-agent", "budget")
    activation = _build_activation("opencode-cli-agent", "ENABLED")
    request = _build_request("opencode-cli-agent", attempt_limit=0)
    result = harness.execute(
        receiver_id="opencode-cli-agent",
        authority=auth,
        activation=activation,
