...
NOTE: this is a standalone characterization script. The executable body is
guarded by ``if __name__ == "__main__":`` so that pytest can import the module
for collection without executing the script (no module-level SystemExit, no
side effects on the live rotation state file).
"""
import sys, os
