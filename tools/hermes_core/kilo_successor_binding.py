"""Canonical Kilo 7.5.15 successor identity and historical EA-4E IDs.
...
CURRENT_EA4E17_ISSUANCE_CONTRACT_ID = (
    "5082b1a227a53cfe711bcf3c5d2193cd47031d75d7ec7650d8ab4c2389194e93"
)
CURRENT_EA4E21_BINDING_CONTRACT_ID = (
    "a25a6ba03b6a44f35511bec4b89c332043cd252ea3d1e185bd1b0a5c966fee33"
)
CURRENT_EA4E22_INTEGRATION_CONTRACT_ID = (
    "0e9d206a0b5d78592bafad624421439774e6c7ffe34a7c9d4c41a66aeb0504bd"
)
...
def kilo_executable_successor_binding_material() -> dict[str, Any]:
    ...
    return {
        ...
        "predecessor_executable_version": "7.5.9",
        "predecessor_transport_contract_id": HISTORICAL_KILO_7_5_9_TRANSPORT_CONTRACT_ID,
